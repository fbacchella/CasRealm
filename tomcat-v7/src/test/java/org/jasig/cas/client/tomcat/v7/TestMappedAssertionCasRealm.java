...
public class TestMappedAssertionCasRealm {
    ...
    private Map<String, Object> checkSession(boolean override) throws IOException {
        ...
        Context c = Mockito.mock(Context.class);
        Mockito.when(c.findSecurityRoles()).thenReturn(new String[] {"admin"});
        ...
        attributes.put("displayName", "Joe Happy");
        attributes.put("role", Collections.singletonList("adminrole"));
